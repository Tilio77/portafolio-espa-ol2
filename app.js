// Función que carga las animaciónes de las habilidades
...
function responsiveMenu() {
  ...
  if(x.className === "") {
    ...
    // Quitamos el boton eliminar cuando se hace click
...
// Agregar una función a cada link del menu responsive
